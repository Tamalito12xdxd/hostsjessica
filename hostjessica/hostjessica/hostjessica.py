...
email="tilindela12xdxd@gmail.com"
password="Muerte"
...
(_／""")
			...
			if x.lower()=="!help" and c==[]:
				try:
					subclient.send_message(chatId=data.message.chatId,message="""[c] L I S T A  D E  C O M A N D O S
[c]━━━━━━━━━━━━━━━━━━━
[BC]●!usuario 
[C] este apartado son para los comandos que cualquier usuario puede utilizar sin problema. 

[CB] ●!staff  
[C]este apartado es para los comandos que solo el staff de la comunidad puede utilizar. 

[CB] ● !Takumi
[C]este apartado es para los comandos que solo el administrador del bot puede hacer. 

[ci]J E S S I C A   B O T ｢✧｣
[c]└───────────────────┘""")
					print(f"Info requested by {data.message.author.nickname}")
				except Exception as e:
					print(e)
					...
					if i[:23]=="http://aminoapps.com/p/" or i[:23]=="http://aminoapps.com/c/":
						...
						if cidx!=cid:
							try:
								...
								print(e)
			if x.lower()=="!usuario" and c==[]:
				try:
					subclient.send_message(chatId=data.message.chatId,message="""[c] COMANDOS PARA USUARIOS
[c]━━━━━━━━━━━━━━━━━━━
● !buenasnoches                       
● !buenosdias 
● !opinar 
					...
					if i[:23]=="http://aminoapps.com/p/" or i[:23]=="http://aminoapps.com/c/":
						...
						if cidx!=cid:
							try:
								...
								print(e)
			if x.lower()=="!staff" and c==[]:
				try:
					subclient.send_message(chatId=data.message.chatId,message="""[c] COMANDOS PARA EL STAFF
[c]━━━━━━━━━━━━━━━━━━━
● !join                       
● !endlive                     
● !say
					...
					if i[:23]=="http://aminoapps.com/p/" or i[:23]=="http://aminoapps.com/c/":
						...
						if cidx!=cid:
							try:
								...
								print(e)
			if x.lower()=="!takumi" and c==[]:
				try:
					subclient.send_message(chatId=data.message.chatId,message="""[c] COMANDOS PARA MI ADMINISTRADOR
[c]━━━━━━━━━━━━━━━━━━━
● !antiraid
● !off
● !clear
...
● !anticras
● !online
[ci]J E S S I C A y T A K U M I 
[c]└───────────────────┘""")
					print(f"Info requested by {data.message.author.nickname}")
				except Exception as e:
					print(e)
